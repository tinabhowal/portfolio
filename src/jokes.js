...
const Jokes = () => {
  return (
    ...
    <div style={{textAlign:'center',  display: 'flex', flexDirection:'column', justifyContent:'center', alignItems:'center'}}>
        ...
        <img src={doodle5} alt='jokes' style={{height:'70vh', width:'80vw'}}></img>
        <p>He went on to explain it further.  :(</p>
        <img src={doodle6} alt='jokes' style={{height:'70vh', width:'80vw'}}></img>
    </div>

    <div style={{textAlign:'center',  display: 'flex', flexDirection:'column', justifyContent:'center', alignItems:'center'}}>
    <p>How my mother taught me about if else statement.</p>    
    <img src={doodle1} alt='jokes' style={{height:'70vh', width:'75vw'}}></img>
    <img src={doodle2} alt='jokes' style={{height:'70vh', width:'75vw'}}></img>
    </div>

    <div style={{textAlign:'center',  display: 'flex', flexDirection:'column', justifyContent:'center', alignItems:'center'}}>
        <p>Did you say imposter syndrome?</p>
        <img src={doodle3} alt='jokes' style={{height:'70vh', width:'75vw'}}></img>
        <img src={doodle4} alt='jokes' style={{height:'70vh', width:'75vw'}}></img>
    </div>
